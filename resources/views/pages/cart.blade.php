                    ...
                    <div class="col-12 table-responsive">
                        <table class="table table-borderless table-cart">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 20%">
                                        <img src="/images/product-cart-1.jpg" alt="product" class="cart-image" />
                                    </td>
                                    <td style="width: 35%">
                                ...
                                <tr>
                                    <td style="width: 20%">
                                        <img src="/images/product-cart-2.jpg" alt="product" class="cart-image" />
                                    </td>
                                    <td style="width: 35%">
                                ...
                                <tr>
                                    <td style="width: 20%">
                                        <img src="/images/product-cart-3.jpg" alt="product" class="cart-image" />
                                    </td>
                                    <td style="width: 35%">
